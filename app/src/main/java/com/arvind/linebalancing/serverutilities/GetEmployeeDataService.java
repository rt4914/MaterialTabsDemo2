...
public class GetEmployeeDataService extends Service {

    private static final String TAG = GetEmployeeDataService.class.getSimpleName();
    ...
    private void getEmployeeDataRequest() {

        String url = Constants.BASE_SERVER_URL + "get_employees";

        mGeneralVolleyRequest.requestToServer(Request.Method.GET, Constants.API_GET_EMPLOYEE,
                url,
                null);
    ...
    private void volleySetup() {
        ...
        IVolleyResponse mRequestCallback = new IVolleyResponse() {
            ...
            public void notifySuccess(String requestType, String response) {
                ...
                if (requestType.matches(Constants.API_GET_EMPLOYEE)) {
    ...
    private void getEmployeeResponse(String sResponse) {
        ...
        try {
            ...
            if (iResponseCode == 100) {
                ...
                AppDatabase.getInstance(this).employeeTableDao().deleteAllEmployees();
    ...
    private void sendResponseToActivity() {
        ...
        Intent intent = new Intent("EMPLOYEE_LIST");
