...
public class GetOperationDataService extends Service {

    private static final String TAG = GetOperationDataService.class.getSimpleName();
    ...
    public GetOperationDataService() {
    }
    ...
    private void getOperationDataRequest() {

        String url = Constants.BASE_SERVER_URL + "get_operations";

        mGeneralVolleyRequest.requestToServer(Request.Method.GET, Constants.API_GET_OPERATION,
                url,
                null);
    ...
    private void volleySetup() {
        ...
        IVolleyResponse mRequestCallback = new IVolleyResponse() {
            ...
            public void notifySuccess(String requestType, String response) {
                ...
                if (requestType.matches(Constants.API_GET_OPERATION)) {
    ...
    private void getOperationResponse(String sResponse) {
        ...
        try {
            ...
            if (iResponseCode == 100) {
                ...
                AppDatabase.getInstance(this).operationTableDao().deleteAllOperations();

                JSONArray messageJSONArray = responseObject.optJSONArray("message");

                for (int i = 0; i < messageJSONArray.length(); i++) {
                    JSONObject operationJSONObject = messageJSONArray.optJSONObject(i);
    ...
    private void sendResponseToActivity() {
        ...
        Intent intent = new Intent("OPERATION_LIST");
