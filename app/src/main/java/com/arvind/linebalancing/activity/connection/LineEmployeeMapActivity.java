...
public class LineEmployeeMapActivity extends AppCompatActivity {

    private static final String TAG = LineEmployeeMapActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line_employee_map);
        ...
        if (data != null && resultCode == RESULT_OK) {
            ...
            if (requestCode == Constants.SELECT_LINE_REQUEST) {
                ...
                if (selectedEmployeeIdList != null && !selectedEmployeeIdList.isEmpty()) {
                    tvSelectEmployee.setText(selectedEmployeeIdList.size() + " employees selected");
                } else {
    ...
    private void initialUISetup() {
        ...
        tvSelectLine.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent ii = new Intent(LineEmployeeMapActivity.this, SelectLineActivity.class);
        ...
        tvSelectEmployee.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent ii = new Intent(LineEmployeeMapActivity.this, SelectEmployeeActivity.class);
    ...
    private void setInitialData() {
        ...
        LineEmployeeMapTable lineEmployeeMapTable = AppDatabase.getInstance(this)
                .lineEmployeeMapTableDao().getLineEmployeeTableById(sLineEmployeeMapId);
        ...
        if (lineEmployeeMapTable != null) {
            ...
            tvSelectEmployee.setText("1 employees selected");
...
//            ivSave.setVisibility(View.GONE);
    ...
    private void enableEditMode(boolean isEditable) {
        ...
        tvSelectEmployee.setClickable(isEditable);
        tvEmployeeLabel.setClickable(isEditable);
    }
    ...
    private void sendUpdateRequest() {
        ...
        if (jsonObject.length() > 0) {
            ...
            mGeneralVolleyRequest.requestToServer(Request.Method.POST, Constants.API_UPDATE_LINE_EMPLOYEE_CONNECTION,
                    Constants.BASE_SERVER_URL + "update_line_employee_connection",
                    params);
    ...
    private void sendAddRequest() {
        ...
        Log.d(TAG, "sendAddRequest: " + selectedEmployeeIdList);
        ...
        mGeneralVolleyRequest.requestToServer(Request.Method.POST, Constants.API_ADD_LINE_EMPLOYEE_CONNECTION,
                Constants.BASE_SERVER_URL + "add_line_employee_connection",
                params);
    ...
    private void addLineEmployeeMapResponse(String sResponse) {
        ...
        try {
            ...
            if (iResponseCode == 100) {
                ...
                JSONObject lineEmployeeMapJSONObject = responseObject.optJSONObject("message");

                DecodeResponse decodeResponse = new DecodeResponse(this);
                decodeResponse.decodeLineEmployeeMapObject(lineEmployeeMapJSONObject);

                if (iEmployeeCount + 1 == selectedEmployeeIdList.size()) {
                    showToast("Line & Employee connection added successfully.");
                    nextActivity();
                } else {
                    iEmployeeCount++;
                    sendAddRequest();
    ...
    private void updateLineEmployeeMapResponse(String sResponse) {
        ...
        try {
            ...
            if (iResponseCode == 100) {
                ...
                showToast("Line & Employee connection updated successfully.");
    ...
    private void titleLabel() {
        ...
        switch (sCurrentMode) {
            case Constants.ACTIVITY_MODE_ADD:
                tvTitleLabel.setText("Line Emp. Connect");
                break;
