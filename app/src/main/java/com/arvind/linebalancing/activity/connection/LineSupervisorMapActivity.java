...
public class LineSupervisorMapActivity extends AppCompatActivity {

    private static final String TAG = LineSupervisorMapActivity.class.getSimpleName();
    ...
    private TextView tvSelectSupervisor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line_supervisor_map);
        ...
        if (data != null && resultCode == RESULT_OK) {
            ...
            if (requestCode == Constants.SELECT_LINE_REQUEST) {
                ...
                if (selectedEmployeeIdList != null && !selectedEmployeeIdList.isEmpty()) {
                    tvSelectSupervisor.setText(selectedEmployeeIdList.size() + " supervisors selected");
                } else {
                    showToast("No supervisor selected.");
                    tvSelectSupervisor.setText("Select Supervisor");
                }
    ...
    private void initialUISetup() {
        ...
        tvSelectSupervisor = findViewById(R.id.tvSelectSupervisor);
        tvLineLabel.setTypeface(utilityFile.getTfMedium());
        tvSelectLine.setTypeface(utilityFile.getTfMedium());
        tvSupervisorLabel.setTypeface(utilityFile.getTfMedium());
        tvSelectSupervisor.setTypeface(utilityFile.getTfMedium());

        tvSelectLine.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent ii = new Intent(LineSupervisorMapActivity.this, SelectLineActivity.class);
        ...
        tvSelectSupervisor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent ii = new Intent(LineSupervisorMapActivity.this, SelectEmployeeActivity.class);
    ...
    private void setInitialData() {
        ...
        LineSupervisorMapTable lineEmployeeMapTable = AppDatabase.getInstance(this)
                .lineSupervisorMapTableDao().getLineSupervisorTableById(sLineEmployeeMapId);
        ...
        if (lineEmployeeMapTable != null) {
            ...
            tvSelectSupervisor.setText("1 supervisors selected");
...
//            ivSave.setVisibility(View.GONE);
    ...
    private void enableEditMode(boolean isEditable) {
        ...
        tvSelectSupervisor.setClickable(isEditable);
        tvSupervisorLabel.setClickable(isEditable);
    }
    ...
    private void sendUpdateRequest() {
        ...
        if (jsonObject.length() > 0) {
            ...
            mGeneralVolleyRequest.requestToServer(Request.Method.POST, Constants.API_UPDATE_LINE_EMPLOYEE_CONNECTION,
                    Constants.BASE_SERVER_URL + "update_line_supervisor_connection",
                    params);
    ...
    private void sendAddRequest() {
        ...
        mGeneralVolleyRequest.requestToServer(Request.Method.POST, Constants.API_ADD_LINE_EMPLOYEE_CONNECTION,
                Constants.BASE_SERVER_URL + "add_line_supervisor_connection",
                params);
    ...
    private void addLineEmployeeMapResponse(String sResponse) {
        ...
        try {
            ...
            if (iResponseCode == 100) {
                ...
                JSONObject lineSupervisorMapJSONObject = responseObject.optJSONObject("message");

                DecodeResponse decodeResponse = new DecodeResponse(this);
                decodeResponse.decodeLineSupervisorMapObject(lineSupervisorMapJSONObject);

                if (iEmployeeCount + 1 == selectedEmployeeIdList.size()) {
                    showToast("Line & Supervisor connection added successfully.");
                    nextActivity();
                } else {
                    iEmployeeCount++;
                    sendAddRequest();
    ...
    private void updateLineEmployeeMapResponse(String sResponse) {
        ...
        try {
            ...
            if (iResponseCode == 100) {
                ...
                showToast("Line & Supervisor connection updated successfully.");
    ...
    private void titleLabel() {
        ...
        switch (sCurrentMode) {
            case Constants.ACTIVITY_MODE_ADD:
                tvTitleLabel.setText("Line Sup. Connect");
                break;
