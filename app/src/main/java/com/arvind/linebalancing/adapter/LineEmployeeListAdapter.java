...
public class LineEmployeeListAdapter extends RecyclerView.Adapter<LineEmployeeListAdapter.MyViewHolder> {

    private static final String TAG = LineEmployeeListAdapter.class.getSimpleName();
    ...
    public LineEmployeeListAdapter(Context context, String sLineId, List<String> employeeIdList) {
...
//        }
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    LineEmployeeMapTable lineEmployeeMapTable = AppDatabase.getInstance(context)
                            .lineEmployeeMapTableDao().getLineEmployeeTableByBothId(sLineId, employeeIdList.get(getAdapterPosition()));

                    Intent i = new Intent(context, LineEmployeeMapActivity.class);
            ...
            public void isDeleted(boolean value, String sAlertDialogType, int adapterPosition) {
                ...
                if(sAlertDialogType.matches("DELETE")){
                    ...
                    if (value) {
                        ...
                        LineEmployeeMapTable lineEmployeeMapTable = AppDatabase.getInstance(context)
                                .lineEmployeeMapTableDao()
                                .getLineEmployeeTableByBothId(sLineId, employeeIdList.get(adapterPosition));
    ...
    private void sendDeleteLineEmployeeRequest(String sLineEmployeeMapId) {
        ...
        mGeneralVolleyRequest.requestToServer(Request.Method.POST, Constants.API_DELETE_LINE_EMPLOYEE_CONNECTION,
                Constants.BASE_SERVER_URL + "delete_line_employee_connection",
                params);
    ...
    private void deleteLineEmployeeResponse(String sResponse) {
        ...
        try {
            ...
            if (iResponseCode == 100) {
                ...
                AppDatabase.getInstance(context).lineEmployeeMapTableDao().deleteLineEmployeeTableById(sLineEmployeeMapId);
                employeeIdList.remove(iPosition);
                notifyItemRemoved(iPosition);
                showToast("Line Employee Connection deleted successfully.");
