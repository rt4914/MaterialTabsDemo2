...
public class LineExecutiveListAdapter extends RecyclerView.Adapter<LineExecutiveListAdapter.MyViewHolder> {

    private static final String TAG = LineExecutiveListAdapter.class.getSimpleName();
    ...
    public LineExecutiveListAdapter(Context context, String sLineId, List<String> employeeIdList) {
...
//        }
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    LineExecutiveMapTable lineEmployeeMapTable = AppDatabase.getInstance(context)
                            .lineExecutiveMapTableDao().getLineExecutiveTableByBothId(sLineId, employeeIdList.get(getAdapterPosition()));

                    Intent i = new Intent(context, LineExecutiveMapActivity.class);
            ...
            public void isDeleted(boolean value, String sAlertDialogType, int adapterPosition) {
                ...
                if(sAlertDialogType.matches("DELETE")){
                    ...
                    if (value) {
                        ...
                        LineExecutiveMapTable lineEmployeeMapTable = AppDatabase.getInstance(context)
                                .lineExecutiveMapTableDao()
                                .getLineExecutiveTableByBothId(sLineId, employeeIdList.get(adapterPosition));
    ...
    private void sendDeleteLineEmployeeRequest(String sLineEmployeeMapId) {
        ...
        mGeneralVolleyRequest.requestToServer(Request.Method.POST, Constants.API_DELETE_LINE_EMPLOYEE_CONNECTION,
                Constants.BASE_SERVER_URL + "delete_line_executive_connection",
                params);
    ...
    private void deleteLineEmployeeResponse(String sResponse) {
        ...
        try {
            ...
            if (iResponseCode == 100) {
                ...
                AppDatabase.getInstance(context).lineExecutiveMapTableDao().deleteLineExecutiveTableById(sLineEmployeeMapId);
                employeeIdList.remove(iPosition);
                notifyItemRemoved(iPosition);
                showToast("Line Executive Connection deleted successfully.");
