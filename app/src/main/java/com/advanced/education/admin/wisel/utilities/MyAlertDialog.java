...
public class MyAlertDialog {
    ...
    public void createDeleteAlertBox(String sTitle, boolean isCancelable, final String sAlertDialogType) {
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (MyDeleteDialogInterface != null) {
                    MyDeleteDialogInterface.isDeleted(true, sAlertDialogType);
                }
        ...
        builder.setNegativeButton("No", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (MyDeleteDialogInterface != null) {
                    MyDeleteDialogInterface.isDeleted(false, sAlertDialogType);
                }
